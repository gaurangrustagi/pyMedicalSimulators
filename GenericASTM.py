...
Conn = ASTM1381.Device( '127.0.0.1', 8000 )
Conn.Open()

ASTM1381.Config_LineNumbering = 1 # include line numbers
ASTM1381.Config_CheckSum_IncludeSTX = 0 # don't include the <2> in the checksum calculation
